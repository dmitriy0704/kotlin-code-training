...
//        В автобусе:
//        cap - количество людей, которое может вместить автобус;
//        on — количество людей в автобусе;
//        wait — количество людей, ожидающих посадки в автобус;
//
//        Если места достаточно, вернуть 0, а если нет, вернуть количество
//        пассажиров, которых он не может взять.


        val total = on + wait
        return if (total > cap) total - cap else 0
